    ...
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
            <a class="navbar-brand brand-logo" href="index.php">
                ...
                <span class="fw-bold " style="font-family: Sofia,sans-serif;"> <span class="fs-2 font-effect-shadow-multiple" >Paperless</span> 
                <!-- <span class="text-primary fs-5 font-effect-shadow-multiple"></span> </span> -->
            </a>
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown d-lg-block user-dropdown">
                <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                    <img class="img-xs rounded-circle" src="images/faces/" alt="Profile image"> </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                    <div class="dropdown-header text-center">
                        <img class="img-md rounded-circle" src="images/faces/" alt="Profile image">
